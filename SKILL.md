...
```
source repo:          skill-publisher/<name>-skill or skill-publisher/dev-skills
general catalog:      skill-publisher/general-skills, for public/paid general skills
dev-skills catalog:   skill-publisher/dev-skills, for bundled meta/dev tools
```
